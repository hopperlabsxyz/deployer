...
if (typeof Bun.env.PRIVATE_KEY !== 'string' || Bun.env.PRIVATE_KEY.startsWith("0x") === false) {
...
export function assertValidChainId(chainId: number): asserts chainId is keyof typeof clients {
